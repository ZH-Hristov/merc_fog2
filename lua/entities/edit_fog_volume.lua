...
ENT.PrintName = "Fog Volume (Cheap)"
ENT.Category = "Fog 2"
...
ENT.Material = Material("mercfogvolume")
...
if CLIENT then
	local mat = Material("mercfogvolume")

	function render.DrawFogVolumeCheap(pos, aabb, density, fogstart, fogend, color, edgefade)
