...
ENT.PrintName = "Fog Volume Sphere"
ENT.Category = "Fog 2"
...
ENT.Material = Material("mercfogvolumesphere")
...
function ENT:SetupFogVolume()
    ...
    mat_SetFloat( mat, "$c2_x", self:GetRadius() )
...
function ENT:SetupDataTables()
    ...
    self:NetworkVar( "Float", 3, "Radius", { KeyName = "radius", Edit = { type = "Float", min = 0, max = 100000, order = 4 } } )
    self:NetworkVar( "Float", 4, "EdgeFade", { KeyName = "edgefade", Edit = { type = "Float", min = 0, max = 10000, order = 5 } } )
